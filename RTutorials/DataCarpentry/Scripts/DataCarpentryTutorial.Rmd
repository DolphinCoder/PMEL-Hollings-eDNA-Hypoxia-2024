...
surveys <- read_csv("~/Dropbox/Coding/Summer2024/PMEL-Hollings-eDNA-Hypoxia-2024/RTutorials/DataCarpentry/RawData/portal_data_joined.csv")
summary(surveys)
names(surveys)
...
ggsave("~/Dropbox/Coding/Summer2024/PMEL-Hollings-eDNA-Hypoxia-2024/RTutorials/DataCarpentry/Figures/plot_combined.png", plot_combined2, width = 10, dpi = 300)
```

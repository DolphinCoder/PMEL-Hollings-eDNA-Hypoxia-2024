...
OCNMS_OME_CTD <- OCNMS_OME_CTD %>% select("date", "year", "depth", "temperature", "DO", "salinity", "potential_density", "pres", "cond")
OCNMS_OME_CTD_TH042 <- OCNMS_OME_CTD_TH042 %>% select("date", "year", "depth", "temperature", "DO", "salinity", "potential_density", "pres", "cond")

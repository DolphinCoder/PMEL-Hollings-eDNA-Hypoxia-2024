...
OCNMS_OME_CTD$date = as.POSIXct(OCNMS_OME_CTD$date, tryFormats = c("%Y-%m-%dT%H:%M:%SZ"))
OCNMS_All_CTD$date = as.POSIXct(OCNMS_All_CTD$date, tryFormats = c("%Y-%m-%dT%H:%M:%SZ"))
...
OCNMS_OME_CTD_TH042 <- OCNMS_OME_CTD %>% 
  filter(near(OCNMS_OME_CTD$depth, 42, tol = 1)) %>% # 191 rows
  filter(station_id == "TH042") # 78 rows
...
OCNMS_OME_CTD_TH042$cond = NA
OCNMS_OME_CTD$pres = NA
OCNMS_OME_CTD_TH042$pres = NA
OCNMS_OME_CTD$source = "CTD"
OCNMS_OME_CTD_TH042$source = "CTD"

OCNMS_OME_CTD <- OCNMS_OME_CTD_TH042 %>% select("source", "date", "year", "depth", "temperature", "DO", "salinity", "potential_density", "pres", "cond", "sampleID")
OCNMS_OME_CTD_TH042 <- OCNMS_OME_CTD_TH042 %>% select("source", "date", "year", "depth", "temperature", "DO", "salinity", "potential_density", "pres", "cond", "sampleID")

write.csv(OCNMS_OME_CTD, file = here("OCNMS_Hypoxia", "Outputs", "OCNMS_CTD_CleanData.csv"))
write.csv(OCNMS_OME_CTD_TH042, file = here("OCNMS_Hypoxia", "Outputs", "OCNMS_CTD_TH042_CleanData.csv"))
```
